    ...
    <SectionWrapper className="py-24 px-6 relative overflow-hidden">
      ...
      <div className="max-w-xl mx-auto text-center relative z-10">
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          <a href="https://wa.me/56961788810" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-[#045490] text-white font-inter text-sm tracking-wide hover:bg-[#273462] transition-colors duration-200">
